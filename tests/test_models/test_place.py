...
class TestPlace_instantiation(unittest.TestCase):
    ...
    def test_two_places_different_created_at(self):
        pl1 = Place()
OAOAOAOAOAOAOAOAOAOA        sleep(0.05)
        pl2 = Place()
OAOAOAOAOAOAOAOAOAOA        self.assertLess(pl1.created_at, pl2.created_at)
OAOAOAOAOAOAOAOAOAOA
    def test_two_places_different_updated_at(self):
OAOAOAOAOAOAOAOAOAOA        pl1 = Place()
        sleep(0.05)
        pl2 = Place()
        self.assertLess(pl1.updated_at, pl2.updated_at)

OAOAOAOAOAOAOAOAOAOA    def test_str_representation(self):
        dt = datetime.today()
        dt_repr = repr(dt)
        pl = Place()
        pl.id = "123456"
...
OAOAOAOAOAOAOAOAOAOA    def test_instantiation_with_kwargs(self):
        dt = datetime.today()
        dt_iso = dt.isoformat()
OAOAOAOAOAOAOAOAOAOA        pl = Place(id="345", created_at=dt_iso, updated_at=dt_iso)
        self.assertEqual(pl.id, "345")
OAOAOAOAOAOAOAOAOAOA        self.assertEqual(pl.created_at, dt)
