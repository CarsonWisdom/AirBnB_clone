...
OAOAOAOAOAOAOAOAOAOA    def test_to_dict_contains_added_attributes(self):
        st = State()
    ...
    def test_to_dict_datetime_attributes_are_strs(self):
        st = State()
        st_dict = st.to_dict()
OAOAOAOAOAOAOAOAOAOA        self.assertEqual(str, type(st_dict["id"]))
        self.assertEqual(str, type(st_dict["created_at"]))
OAOAOAOAOAOAOAOAOAOA        self.assertEqual(str, type(st_dict["updated_at"]))
